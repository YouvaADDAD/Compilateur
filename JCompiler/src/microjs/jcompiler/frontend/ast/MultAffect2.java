...
public class MultAffect2 extends Statement {
	private String var1;
    private String var2;
	private Expr p;
    private List<Statement> list;
	public MultAffect2(String var1,String var2,Expr p,List<Statement> list,Location startPos, Location endPos) {
		...
		public KStatement expand() {
			...
			KStatement expr1=new Let(var2, new Cdr(p,getStartPos(),getEndPos()), list, getStartPos(), getEndPos()).expand();
			List<String> params=new ArrayList<>();
			params.add(var1);
			KClosure fun2 = new KClosure(params, expr1, getStartPos(), getEndPos());
			List<KExpr> kargs=new ArrayList<>();
	    	kargs.add(new Car(p,getStartPos(),getEndPos()).expand());
